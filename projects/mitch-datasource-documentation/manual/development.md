...
-   `netlify-cli` to automate the release process for the static HTML documentation generated by `esdoc` to `netlify` static website hosting service. Used as part of `semantic-release` (called through node `npx` command).
